...
/datum/game_mode/chaosmode/proc/pick_aspirants()
	var/list/possible_jobs_aspirants = list("Scion", "Guard Captain", "Steward", "Hand", "Knight")
	var/list/possible_jobs_helpers = list("Guard Captain", "Scion", "Hand",  "Steward", "Knight")
